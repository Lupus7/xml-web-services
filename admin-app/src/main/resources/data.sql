...
insert into car(id, total_mileage, allowed_mileage, children_seats, description, protection, owner, brand_id, model_id, fuel_id, transmission_id, class_id)
        values (100, 10, 10, 2, 'as', true, 2, 30, 30, 30, 30, 30);
