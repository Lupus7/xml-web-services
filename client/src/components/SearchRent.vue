    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: "Card", label: "Car Info", sortable: false },
                { key: "TotalMileage", label: "Traveled Km", sortable: true },
                {
                    key: "AllowedMileage",
                    label: "Predicted Km",
                    sortable: true
                ...
                { key: "Rating", label: "Rate", sortable: true },
                { key: "moredetails", label: "" }
            ],
            adds: [],
            placeF: "",
            take_overF: "",
                ...
                .then(response => {
                    ...
                    for (let res of response.data) {
                        if (res.Advertiser !== this.email) {
                            ...
                            axios
                                .get("/cars-ads/pricelist/ad/" + res.Id)
                                .then(response => {
                                    pricelist = response.data;

                                    axios
                                        .get("/cars-ads/ad/" + res.Id + "/car")
                                        .then(response => {
                                            carId = response.data;
                                            if (carId && pricelist)
                                                axios
