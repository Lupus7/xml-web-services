insert into users(id, cart, approved, blocked, email, first_name, last_name, business_number, company_name, address, authorities, password) values (1, 1, true, false, 'user', 'Joseph', 'Joestar', '1', '', 'some address', 'ROLE_CLIENT;UPDATE_CART;DELETE_FROM_CART;READ_CART;CREATE_BOOKING;ACCEPT_BOOKING;CANCEL_BOOKING;REJECT_BOOKING;RESEVE_BOOKING;CREATE_AD;ACTIVATE_AD;DEACTIVATE_AD;EDIT_AD;READ_CLIENT_ADS;CREATE_CAR;READ_CAR;EDIT_CAR;DELETE_CAR;READ_CLIENT_CARS;READ_BOOKINGS', '$2a$10$GuztdmZFDUgqX/FvWCMPdu/lUfkHxxs8bkJvw6IxvSJv3T54SU6ea');
...
insert into users(id, cart, approved, blocked, email, first_name, last_name, business_number, company_name, address, authorities, password) values (4, 2, true, false, 'user1', 'Johny', 'Joestar', '4', '', 'some address', 'ROLE_CLIENT;UPDATE_CART;DELETE_FROM_CART;READ_CART;CREATE_BOOKING;ACCEPT_BOOKING;CANCEL_BOOKING;REJECT_BOOKING;RESEVE_BOOKING;CREATE_AD;ACTIVATE_AD;DEACTIVATE_AD;EDIT_AD;READ_CLIENT_ADS;CREATE_CAR;READ_CAR;EDIT_CAR;DELETE_CAR;READ_CLIENT_CARS;READ_BOOKINGS', '$2a$10$GuztdmZFDUgqX/FvWCMPdu/lUfkHxxs8bkJvw6IxvSJv3T54SU6ea');
