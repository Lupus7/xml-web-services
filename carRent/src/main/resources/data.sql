insert into users(id, approved, blocked, email, first_name, last_name, business_number, company_name, address, authorities, password) values (1, true, false, 'user', 'Johh', 'Doe', '1', '', 'some address', 'ROLE_CLIENT;READ_ADS;SEND_RENT_REQUEST;READ_USER_PRIVILEGES;UPDATE_CART;DELETE_FROM_CART;READ_CART;CREATE_BOOKING;ACCEPT_BOOKING;CANCEL_BOOKING;READ_BOOKINGS', '$2a$10$GuztdmZFDUgqX/FvWCMPdu/lUfkHxxs8bkJvw6IxvSJv3T54SU6ea');
...
insert into users(id, approved, blocked, email, first_name, last_name, business_number, company_name, address, authorities, password) values (4, true, false, 'user1', 'Johhy', 'Joestar', '1', '', 'some address', 'ROLE_CLIENT;READ_ADS;SEND_RENT_REQUEST;READ_USER_PRIVILEGES;UPDATE_CART;DELETE_FROM_CART;READ_CART;CREATE_BOOKING;ACCEPT_BOOKING;CANCEL_BOOKING;READ_BOOKINGS', '$2a$10$GuztdmZFDUgqX/FvWCMPdu/lUfkHxxs8bkJvw6IxvSJv3T54SU6ea');
...
insert into car_ads(car_id, ads_id) values (1, 1);
insert into car_ads(car_id, ads_id) values (1, 2);
insert into car_ads(car_id, ads_id) values (2, 3);
insert into car_ads(car_id, ads_id) values (3, 14);